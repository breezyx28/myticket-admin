...
import { OrganizerProfilesPage, VendorProfilesPage } from '@/pages/approvals/ProfileDirectoriesPage';
      ...
      <Routes>
        ...
        <Route element={<RequireAdmin />}>
          <Route element={<AdminShell />}>
            ...
            <Route path="approvals/organizers" element={<OrganizerProfilesPage />} />
            ...
            <Route path="settings/refund-breakdowns" element={<RefundBreakdownsPage />} />
            <Route path="settings/payouts" element={<PayoutsPage />} />
            <Route path="settings/finance-compliance" element={<FinanceCompliancePage />} />
