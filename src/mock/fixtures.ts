...
export const MOCK_SCANNERS = adminScannerListSchema.parse([
  ...
  },
  {
    ...
    status: 'offline',
    organizerProfileId: '2',
    organizerName: 'Desert Sound LLC',
    organizerCompanyName: 'Desert Sound LLC',
    organizerCode: 'ORG-DSND',
...
export const MOCK_SCAN_LOGS = adminScanLogListSchema.parse([
  {
    ...
    result: 'ok',
    scannerId: '5',
    scannerCode: 'SCN-GATE-A',
    scannerName: 'Gate A',
    scannerEmail: 'gate@example.com',
    scannerLabel: 'Gate A (SCN-GATE-A)',
    organizerProfileId: '1',
    organizerName: 'Desert Events Co',
    ...
    ticketId: '99',
    ticketCode: 'TIC-88421-A',
    ticketRef: 'TIC-88421-A',
    ticketStatus: 'used',
    ticketOrderId: '42',
  ...
  {
    id: '2',
    scannedAt: '2026-06-14T12:01:44+00:00',
    outcome: 'duplicate',
    result: 'duplicate',
    scannerId: '5',
    scannerCode: 'SCN-GATE-A',
  ...
  {
    id: '3',
    scannedAt: '2026-06-14T12:05:01+00:00',
    outcome: 'invalid',
    result: 'invalid',
    scannerId: '6',
    scannerCode: 'SCN-VIP',
    scannerName: 'VIP lane handheld',
    scannerLabel: 'VIP lane handheld (SCN-VIP)',
    eventId: '18',
    eventTitle: 'Summer Festival',
    eventDetailPath: '/events/18',
    ticketCode: 'TIC-00000-X',
    ticketRef: 'TIC-00000-X',
  },
]);
...
export const MOCK_ADMIN_RECENT_NOTIFICATIONS = adminRecentNotificationListSchema.parse([
  {
    ...
    body: '"Desert Soundscape" has been approved and is now published.',
    kind: 'general',
    href: '/events/1',
    ...
    read: false,
    createdAt: '2026-06-21T19:21:21.000000Z',
  },
  {
    id: '20',
    title: 'Organizer event requires review',
    body: 'Event updated: Desert Soundscape',
    ...
    eventCode: 'EVT-00000001',
    read: false,
    createdAt: '2026-06-21T19:08:06.000000Z',
  },
  {
    id: '19',
    title: 'Organizer event requires review',
    ...
    eventCode: 'EVT-00000001',
    read: true,
    readAt: '2026-06-21T19:07:00.000000Z',
    createdAt: '2026-06-21T19:07:54.000000Z',
  },
  {
    id: 'nr-2',
    ...
    relatedEntityType: 'tourism_ad',
    relatedEntityId: 'ta-1',
    read: false,
