    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-[14px] text-ink-60">
          Ticket purchases across the platform. Full refunds are started from the order detail page when policy allows
          and your account has permission.
        </p>
      </div>
            ...
            <table className="w-full min-w-[720px] text-left text-[14px]">
              ...
              <tbody>
                {filtered.map((row) => (
                  <tr
                    key={row.id}
                    className="border-t border-ink-10 hover:bg-surface-tint"
                  >
                    ...
                    <td className="px-4 py-3 capitalize text-ink-60">
                      {statusLabel(row.status)}
                    </td>
                    <td className="px-4 py-3 font-mono text-ink">
                      {row.totalSar.toLocaleString()}
                    </td>
